...
//
//  In extension -> options -> alllowed link :  localhost
//
...
var cmd="chrome --disable-extensions-file-access-check --no-pings --disable-background-mode --load-extension=\""+Shell.getcwd()+"\\source.chrome\" --no-first-run --homepage \""+url+"\"";
Console.writeLn(cmd);
Shell.system(cmd);
